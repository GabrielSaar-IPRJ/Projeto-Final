  ...
  return (
    <div className="flex flex-row justify-center absolute w-full h-full z-1 top-22">
      <form
        ...
        <a className="text-black font-bold text-2xl w-full text-center">Criar Novo Evento</a>
        <input 
            type="text" 
            id="title" 
        ...
        <input 
            ...
            ref={dateRef}
            className="text-black border border-azul p-4 rounded-xl w-full"/>
        <Button variant="outline" className="w-[20%] text-white bg-azul border border-azul hover:bg-blue-100 font-bold">CRIAR</Button>
      </form>
    </div>
  )
}